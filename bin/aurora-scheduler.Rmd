08:59:07,852 |-INFO in ch.qos.logback.classic.LoggerContext[default] - Could NOT find resource [logback-test.xml]
08:59:07,852 |-INFO in ch.qos.logback.classic.LoggerContext[default] - Could NOT find resource [logback.groovy]
08:59:07,852 |-INFO in ch.qos.logback.classic.LoggerContext[default] - Found resource [logback.xml] at [jar:file:/opt/share/git_aurora/dist/distributions/aurora/aurora-scheduler-0.21.0-SNAPSHOT/lib/aurora-0.21.0-SNAPSHOT.jar!/logback.xml]
08:59:07,863 |-INFO in ch.qos.logback.core.joran.spi.ConfigurationWatchList@12f40c25 - URL [jar:file:/opt/share/git_aurora/dist/distributions/aurora/aurora-scheduler-0.21.0-SNAPSHOT/lib/aurora-0.21.0-SNAPSHOT.jar!/logback.xml] is not of type file
08:59:07,925 |-INFO in ch.qos.logback.core.joran.action.AppenderAction - About to instantiate appender of type [ch.qos.logback.core.ConsoleAppender]
08:59:07,927 |-INFO in ch.qos.logback.core.joran.action.AppenderAction - Naming appender as [STDERR]
08:59:07,936 |-INFO in ch.qos.logback.core.joran.action.NestedComplexPropertyIA - Assuming default type [ch.qos.logback.classic.encoder.PatternLayoutEncoder] for [encoder] property
08:59:07,955 |-INFO in ch.qos.logback.classic.joran.action.LoggerAction - Setting level of logger [h2database] to WARN
08:59:07,955 |-INFO in ch.qos.logback.classic.joran.action.RootLoggerAction - Setting level of ROOT logger to INFO
08:59:07,955 |-INFO in ch.qos.logback.core.joran.action.AppenderRefAction - Attaching appender named [STDERR] to Logger[ROOT]
08:59:07,955 |-INFO in ch.qos.logback.classic.joran.action.ConfigurationAction - End of configuration.
08:59:07,956 |-INFO in ch.qos.logback.classic.joran.JoranConfigurator@b684286 - Registering current configuration as safe fallback point
